...
- 13 หน้า HTML: `index.html` (root, นับสต็อก) + `Html/` อีก 12 หน้า (import_counts, count_search, audit_check, reconcile, cycle_config, book_explorer, sku_master, dashboard, settings, chat, live_count_wall, user_manual)
