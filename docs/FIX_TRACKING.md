...
| `Js/settings-shared.js` | **9 หน้า** — index, import_counts, count_search, audit_check, reconcile, live_count_wall, sku_master, settings, cycle_config (ยกเว้น book_explorer, chat, user_manual, **dashboard** — dashboard มี connection pill ของตัวเอง) |
| `Js/sku-utils.js` | index, import_counts, count_search, audit_check, reconcile, dashboard, live_count_wall, sku_master, cycle_config |
| `Js/db-errors.js` | **4 หน้า** — index, import_counts, audit_check, sku_master (ถอดออกจาก count_search/cycle_config/dashboard/live_count_wall/reconcile เมื่อ 2026-08-10 เพราะไม่มีการเรียกใช้) |
